...
const Log = () => {
  ...
  const loginUser = (event) => {
    ...
    axios
      .post("http://localhost:3002/LoginUsers", {
    ...
    <section className="login-service">
      ...
      <form onSubmit={loginUser}>
        <div className={statusHolder}>
          <span className="login-state">{loginStatus}</span>
        </div>
        <CodeText
        ...
        <div className="button-division">
          <div className="help-container">
            <Link to="/">
              <p> olvidaste tu contraseña o usuario?</p>
            </Link>
            <Link to="/UsersReg">
              <p> Aun no te has registrado? hazlo ahora!</p>
            </Link>
          </div>
